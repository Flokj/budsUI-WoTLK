...
L_POPUP_RELOADUI = "Installation is complete. Please click 'Accept' to reload the UI.|n|n|cffffe02eIMPORTANT:|r Type |cff388bdb/buds|r in chat after the loading screen to open the config menu and customize the UI to your liking!|n|nEnjoy |cff388bdbbudsUI|r!"
...
L_INSTALL_TITLE = "|cff388bdbInstallation Wizard|r"
L_INSTALL_BTN_PREV = "< Previous"
L_INSTALL_BTN_NEXT = "Next >"
L_INSTALL_BTN_DONE = "Finish"
L_INSTALL_BTN_SKIP = "Skip"
L_INSTALL_STEP_TXT = "Step %d of %d"
L_INSTALL_ERROR = "|cffff0000budsUI Install Error:|r "

L_INSTALL_STEP1_TITLE = "Welcome to budsUI!"
L_INSTALL_STEP1_DESC = "This wizard will help you set up budsUI optimally.\n\nWe will configure the following areas:\n\n• Interface Settings\n• Graphics & Camera\n• Combat & Tooltips\n• Chat Settings\n• Chat Window Layout\n• Miscellaneous\n\nClick 'Next' to begin."
L_INSTALL_STEP2_TITLE = "Step 1: Interface"
L_INSTALL_STEP2_DESC = "Configure basic interface settings:\n\n• Always show action bars\n• Lock action bars\n• Enable auto-dismount\n• Enable quest tracking\n• Set auto-loot key to SHIFT\n• Set self-cast key to ALT"
L_INSTALL_STEP3_TITLE = "Step 2: Graphics & Camera"
L_INSTALL_STEP3_DESC = "Optimize graphics and camera settings:\n\n• Max camera distance to 50\n• Screenshot quality to maximum\n• Auto-adjust UI scaling\n• Violence level to maximum"
L_INSTALL_STEP4_TITLE = "Step 3: Combat & Tooltips"
L_INSTALL_STEP4_DESC = "Configure combat-related settings:\n\n• Show buff duration\n• Enable threat warning\n• Advanced tooltips\n• Class colors in nameplates\n• Disable buff consolidation"
L_INSTALL_STEP5_TITLE = "Step 4: Chat Settings"
L_INSTALL_STEP5_DESC = "Optimize chat features:\n\n• Enable mouse wheel scrolling\n• Use classic chat style\n• Remove chat delay\n• Configure spam filter"
L_INSTALL_STEP6_TITLE = "Step 5: Chat Windows"
L_INSTALL_STEP6_DESC = "Set up chat windows:\n\n• Create 5 chat windows\n• Window 1: General (Say, Yell, Emote, System)\n• Window 2: Guild Log\n• Window 3: Loot (Loot, XP, Gold)\n• Window 4: Trade\n• Window 5: Group (Whisper, Party, Raid, BG)\n• Enable class colors in all channels"
L_INSTALL_STEP7_TITLE = "Step 6: Miscellaneous"
L_INSTALL_STEP7_DESC = "Final settings:\n\n• Disable minimap rotation\n• Hide newbie tips\n• Disable tutorials\n• Configure error reporting"
L_INSTALL_STEP8_TITLE = "Installation Complete!"
L_INSTALL_STEP8_DESC = "All settings have been successfully configured.\n\nbudsUI is now ready for use!\n\nClick 'Finish' to reload the interface.\n\nEnjoy budsUI!\n\nVisit: |cff388bdbwww.github.com/Budtender3000/budsUI|r"
